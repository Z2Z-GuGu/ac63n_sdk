...
const char log_info_enable = 1;
const char log_debug_enable = 0;  //默认关闭
const char log_error_enable = 1;
#else
const char log_info_enable = 0;
const char log_debug_enable = 0;
const char log_error_enable = 0;
#endif
...
/************************** dual_bank_update  uart config ****************************/
const struct uart_platform_data dual_uart_config = {
    .id = 1,
    .tx_pin = IO_PORTA_06,
    .rx_pin = IO_PORTA_08,
    .baudrate = 9600,
...
const struct spi_platform_data spi1_p_data = {
    .port = {
        IO_PORTB_04,    //CLK
        IO_PORTB_05,    //DO //单线模式时:PB1/PB4/PB6/PB8/PB9/PA1/PA2/PA3/PA5/PA6/PA7/PA8/PA9不可用
        //单线模式时:PB0/PB3/PB5/PB7/PA0/PA4/DP/DM/DP1/DM1可用
        IO_PORTB_06,    //DI
    },
...
const struct soft_iic_config soft_iic_cfg[] = {
    {
        //iic0 data
        .scl = IO_PORTA_06,      //IIC CLK脚
        .sda = IO_PORTA_07,      //IIC DAT脚
...
const struct low_power_param power_param = {
    ...
    .vddiom_lev     = VDDIOM_VOL_30V,          			   //强VDDIO等级,可选：2.0V  2.2V  2.4V  2.6V  2.8V  3.0V  3.2V  3.6V .vddiow_lev     = TCFG_LOWPOWER_VDDIOW_LEVEL,
...
static void close_gpio(void)
{
    ...
    port_protect(port_group, IO_PORTB_01);	//protect VCM_IO
