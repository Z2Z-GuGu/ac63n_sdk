...
#define    LCTM_CHL0_RES_H       P11_CTM(0x19)
#define    LCTM_CHL0_RES_L       P11_CTM(0x1a)
...
#define    LCTM_CHL1_RES_H       P11_CTM(0x29)
#define    LCTM_CHL1_RES_L       P11_CTM(0x2a)
...
#define P2M_CTMU_CH1_L_TRIM_VALUE   		P11_P2M_ACCESS(8)
#define P2M_CTMU_CH1_H_TRIM_VALUE   		P11_P2M_ACCESS(9)
#define P2M_CTMU_CH1_L_DIFF_VALUE   		P11_P2M_ACCESS(10)
#define P2M_CTMU_CH1_H_DIFF_VALUE   		P11_P2M_ACCESS(11)
#define P2M_CTMU_CH0_L_IIR_VALUE    		P11_P2M_ACCESS(12)
#define P2M_CTMU_CH0_H_IIR_VALUE    		P11_P2M_ACCESS(13)
#define P2M_CTMU_CTMU_KEY_CNT      			P11_P2M_ACCESS(14)
#define P2M_CTMU_CTMU_WKUP_MSG				P11_P2M_ACCESS(15)
#define P2M_REPLY_COMMON_CMD        		P11_P2M_ACCESS(16)
...
#define M2P_CRITICAL_CMD1            		P11_M2P_ACCESS(31)
#define M2P_CRITICAL_CMD2			 		P11_M2P_ACCESS(32)
#define M2P_CTMU_CH1_TRIM_VALUE_L			P11_M2P_ACCESS(33)
#define M2P_CTMU_CH1_TRIM_VALUE_H			P11_M2P_ACCESS(34)
#define M2P_CTMU_CH1_RES_SEND    			P11_M2P_ACCESS(35)

//FOR LPCTMU LONG CLICK RESET
#define M2P_LCTM_RESET_PCNT_PRD0			P11_M2P_ACCESS(36)
#define M2P_LCTM_RESET_PCNT_PRD1			P11_M2P_ACCESS(37)
#define M2P_LCTM_RESET_PCNT_VALUE			P11_M2P_ACCESS(38)

#define M2P_COMMON_CMD            			P11_M2P_ACCESS(39)

#define M2P_CTM_INEAR_VALUE_L				P11_M2P_ACCESS(40)
#define M2P_CTM_INEAR_VALUE_H				P11_M2P_ACCESS(41)
#define M2P_CTM_OUTEAR_VALUE_L				P11_M2P_ACCESS(42)
#define M2P_CTM_OUTEAR_VALUE_H				P11_M2P_ACCESS(43)
#define M2P_CTMU_CH0_RES_SEND		P11_M2P_ACCESS(44)
