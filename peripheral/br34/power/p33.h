...
#define PVDD_VOL_MIN                      950//mV
#define PVDD_VOL_STEP                     50 //mV
#define PVDD_VOL_LOW 					  700 //mv, 如果出现异常, 可以抬高该电压值
...
#define P3_WKUP_EN                        P33_ACCESS(0x50)
#define P3_WKUP_LIE                       P33_ACCESS(0x51)
#define P3_WKUP_EIE                       P33_ACCESS(0x52)
#define P3_WKUP_BOTH_EDGE                 P33_ACCESS(0x53)
#define P3_WKUP_EDGE                      P33_ACCESS(0x54)
#define P3_WKUP_CPND                      P33_ACCESS(0x55)
#define P3_WKUP_LEVEL                     P33_ACCESS(0x56)
#define P3_WKUP_PND                       P33_ACCESS(0x57)
#define P3_PORT_FLT0                      P33_ACCESS(0x58)
#define P3_PORT_FLT1                      P33_ACCESS(0x59)
#define P3_PORT_FLT2                      P33_ACCESS(0x5a)
#define P3_PORT_FLT3                      P33_ACCESS(0x5b)
#define P3_PORT_FLT4                      P33_ACCESS(0x5c)
#define P3_PORT_FLT5                      P33_ACCESS(0x5d)
#define P3_PORT_FLT6                      P33_ACCESS(0x5e)
#define P3_PORT_FLT7                      P33_ACCESS(0x5f)
...
#define P3_LS_AUDIO                       P33_ACCESS(0xd4)
#define P3_LS_RF                          P33_ACCESS(0xd5)
#define P3_LS_PLL                         P33_ACCESS(0xd6)
...
#define R3_ALM_CON                        P33_ACCESS((0x80 | RTC_SFR_BEGIN))

#define R3_RTC_CON0                       P33_ACCESS((0x84 | RTC_SFR_BEGIN))
#define R3_RTC_CON1                       P33_ACCESS((0x85 | RTC_SFR_BEGIN))
#define R3_RTC_DAT0                       P33_ACCESS((0x86 | RTC_SFR_BEGIN))
#define R3_RTC_DAT1                       P33_ACCESS((0x87 | RTC_SFR_BEGIN))
#define R3_RTC_DAT2                       P33_ACCESS((0x88 | RTC_SFR_BEGIN))
#define R3_RTC_DAT3                       P33_ACCESS((0x89 | RTC_SFR_BEGIN))
#define R3_RTC_DAT4                       P33_ACCESS((0x8a | RTC_SFR_BEGIN))

//............. 0x0090 - 0x009f............ for PORT control
#define R3_WKUP_EN                        P33_ACCESS((0x90 | RTC_SFR_BEGIN))
#define R3_WKUP_EDGE                      P33_ACCESS((0x91 | RTC_SFR_BEGIN))
#define R3_WKUP_CPND                      P33_ACCESS((0x92 | RTC_SFR_BEGIN))
#define R3_WKUP_PND                       P33_ACCESS((0x93 | RTC_SFR_BEGIN))
#define R3_WKUP_FLEN                      P33_ACCESS((0x94 | RTC_SFR_BEGIN))
#define R3_PORT_FLT                       P33_ACCESS((0x95 | RTC_SFR_BEGIN))

#define R3_PR_IN                          P33_ACCESS((0x98 | RTC_SFR_BEGIN))
#define R3_PR_OUT                         P33_ACCESS((0x99 | RTC_SFR_BEGIN))
#define R3_PR_DIR                         P33_ACCESS((0x9a | RTC_SFR_BEGIN))
#define R3_PR_DIE                         P33_ACCESS((0x9b | RTC_SFR_BEGIN))
#define R3_PR_PU                          P33_ACCESS((0x9c | RTC_SFR_BEGIN))
#define R3_PR_PD                          P33_ACCESS((0x9d | RTC_SFR_BEGIN))
#define R3_PR_HD                          P33_ACCESS((0x9e | RTC_SFR_BEGIN))

//............. 0x00a0 - 0x00af............ for system
#define R3_TIME_CON                       P33_ACCESS((0xa0 | RTC_SFR_BEGIN))
#define R3_TIME_CPND                      P33_ACCESS((0xa1 | RTC_SFR_BEGIN))
#define R3_TIME_PND                       P33_ACCESS((0xa2 | RTC_SFR_BEGIN))

#define R3_ADC_CON                        P33_ACCESS((0xa4 | RTC_SFR_BEGIN))
#define R3_OSL_CON                        P33_ACCESS((0xa5 | RTC_SFR_BEGIN))

#define R3_WKUP_SRC                       P33_ACCESS((0xa8 | RTC_SFR_BEGIN))
#define R3_RST_SRC                        P33_ACCESS((0xa9 | RTC_SFR_BEGIN))

#define R3_RST_CON                        P33_ACCESS((0xab | RTC_SFR_BEGIN))
#define R3_CLK_CON                        P33_ACCESS((0xac | RTC_SFR_BEGIN))
...
#define BTDCDC_HD_BIAS_SEL(sel) P33_CON_SET(P3_ANA_CON8, 2, 2, sel)
//Macro for BTDCDC_HD_BIAS_SEL
enum {
 ...
 *-------------------P3_ANA_CON10
 */
#define BTDCDC_SENRES_HALF(en)  P33_CON_SET(P3_ANA_CON10, 7, 1, en)

#define BTDCDC_LATCH_ZCD_EN(en) P33_CON_SET(P3_ANA_CON10, 6, 1, en)

#define BTDCDC_ZCD_RESBIAS_SEL(sel) P33_CON_SET(P3_ANA_CON10, 4, 2, sel)

#define BTDCDC_ZCD_CAP_SEL(sel) P33_CON_SET(P3_ANA_CON10, 2, 2, sel)
...
#define BTDCDC_TEST_EN(en)      P33_CON_SET(P3_ANA_CON13, 5, 1, en)
 ...
 *-------------------P3_ANA_CON14
 */
#define BTDCDC_CLK_SEL(sel)     P33_CON_SET(P3_ANA_CON14, 7, 1, sel)
#define GET_BTDCDC_CLK_SEL()    (P33_CON_GET(P3_ANA_CON14) & BIT(7) ? 1 : 0)

#define BTDCDC_HD_EAMP(sel)    P33_CON_SET(P3_ANA_CON14, 5, 1, sel)
...
#define SYSPLL_DPLL_REF(a)      P33_CON_SET(P3_VLVD_KEEP, 2, 1, en)
