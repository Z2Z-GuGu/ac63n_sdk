...
//---------- 模块模拟配置 ------------//
#define LP_CTMU_CH0_VL_SEL(x) 	SFR(LCTM_CHL0_ANA, 5, 2, x) //CH0下限电压
#define LP_CTMU_CH0_VH_SEL(x) 	SFR(LCTM_CHL0_ANA, 3, 2, x) //CH0上限电压
#define LP_CTMU_CH0_CUR_SEL(x) 	SFR(LCTM_CHL0_ANA, 0, 3, x) //CH0充放电电流

#define LP_CTMU_CH1_VL_SEL(x) 	SFR(LCTM_CHL1_ANA, 5, 2, x) //CH1下限电压
#define LP_CTMU_CH1_VH_SEL(x) 	SFR(LCTM_CHL1_ANA, 3, 2, x) //CH1上限电压
#define LP_CTMU_CH1_CUR_SEL(x) 	SFR(LCTM_CHL1_ANA, 0, 3, x) //CH1充放电电流
