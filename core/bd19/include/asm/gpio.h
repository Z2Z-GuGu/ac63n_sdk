...
/**
 * @brief usb1_iomode, usb1引脚设为普通IO
 *
 * @param enable 1，使能；0，关闭
 */
...
enum PFI_TABLE {
    ...
    PFI_MCPWM_TMR1_CLKI = ((u32)(&(JL_IMAP->FI_MCPWM_TMR1_CLKI))),
    PFI_MCPWM_TMR2_CLKI = ((u32)(&(JL_IMAP->FI_MCPWM_TMR2_CLKI))),
    PFI_MCPWM_TMR3_CLKI = ((u32)(&(JL_IMAP->FI_MCPWM_TMR3_CLKI))),
