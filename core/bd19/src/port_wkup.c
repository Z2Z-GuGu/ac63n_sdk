...
void port_wkup_interrupt_init(u32 port, u8 trigger_edge, void (*cbfun)(void))
{
    ...
    gpio_set_fun_input_port(port, PFI_GP_ICH0);	 		//映射任意引脚为inputchannel0
...
void my_port_wkup_test(void)
{
    port_wkup_interrupt_init(IO_PORTA_06, 0, port_irq_cbfun);//上升沿触发
