...
void ir_timer_init(u8 timer_num)
{
    ...
    case 0:
        ...
        request_irq(IRQ_TIME0_IDX, 3, ir_timer_isr, 0);
        break;
    case 1:
        IR_TIME_REG = JL_TIMER1;
        request_irq(IRQ_TIME1_IDX, 3, ir_timer_isr, 0);
        break;
    case 2:
        IR_TIME_REG = JL_TIMER2;
        request_irq(IRQ_TIME2_IDX, 3, ir_timer_isr, 0);
        break;
    case 3:
        IR_TIME_REG = JL_TIMER3;
        request_irq(IRQ_TIME3_IDX, 3, ir_timer_isr, 0);
        break;
    default:
        return;
    }
...
IRFLT_PLATFORM_DATA_BEGIN(test_irflt_pdata)
    .ir_io = IO_PORTA_03,   //红外信号捕获引脚
    .timer_num = 3,         //选用timer3
