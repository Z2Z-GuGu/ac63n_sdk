...
#define EEPROM_USE_IIC_TYPE  1//0:soft iic  1:hw iic
#define EEPROM_BYTE_WRITE    1//0:buf write  1:byte write
#define EEPROM_BYTE_READ     1//0:buf read  1:byte read
#if EEPROM_USE_IIC_TYPE
#define iic_dev                             0
